...
<?php include PATH_CONTROLLER.'postedit.php'; ?>
  ...
  <div class="row justify-content-center">
    <div class="col-12 col-md-5">
      ...
      <form action="" method="post">
        ...
        <div class="row align-items-center">
          <div class="col mt-4 form-group">
            <textarea rows="5" class="form-control" name="content"><?php echo $post->content; ?></textarea>
            <?php echo @(isset($errors['content'])) ? print_err($errors['content']) : ''; ?>
          </div>
        </div>
        <div class="row justify-content-start">
          <div class="col">
            <button type="submit" name="submit" class="btn btn-primary mt-4 reg-btn">Update & Publish</button>
